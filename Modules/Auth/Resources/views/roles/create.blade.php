                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.roles.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="display_name" type="display_name" class="form-control @error('display_name') is-invalid @enderror" name="display_name" value="{{ old('display_name') }}" required autocomplete="display_name" autofocus>
