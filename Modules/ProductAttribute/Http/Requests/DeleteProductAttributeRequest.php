...
/**
 * Class DeleteProductAttributeRequest.
 */
class DeleteProductAttributeRequest extends FormRequest
{
    /**
     * @var BaseRepository
    */
    protected $baseRepo;
    /**
     * DeleteProductAttributeRequest constructor.
     *
     */
    ...
    {
      //delete ProductAttribute for only superadministrator  and admins
